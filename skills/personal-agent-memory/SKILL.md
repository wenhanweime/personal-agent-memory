...
description: 使用 Personal Agent Memory 为 Claude Code、Codex、OpenClaw、Hermes 等 coding agents 配置共享本地长期记忆。Use when the user asks to remember, save, recall, search, install, audit, or troubleshoot agent memory, hooks, MCP memory, encrypted secrets, Basic Memory integration, or cross-agent project context.
---
...
如果 npm 包已经发布，也可以使用 `npm install -g personal-agent-memory`。当前 GitHub 安装路径是最稳的公开可用路径。
